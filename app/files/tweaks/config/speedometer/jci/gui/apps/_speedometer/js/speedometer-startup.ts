...
const isMPH = false;
const language = 'DE';
const fuelEffunit_kml = false;
const noNavSD = false;
const hideSbSpeedoSBN = false;
const black_background_opacity = 0.0;
const original_background_image = false;
const startAnalog = false;
const barSpeedometerMod = false;
const speedMod = false;
const engineSpeedBar = false;
const hideSpeedBar = false;
const speedAnimation = false;
const tempIsF = false;
const spdLrgTxt = false;
const analogColor = 'Red';
const speedometerTheme = 0;
const sbFuelBar = false;
const sbHideInApp = true;
const sbfbPos = '';
const SbMain = 'gpsSpeedValue';
const SbVal1 = 'gpsHeading';
const SbVal2 = 'gpsAltitudeValue';
const sbInterval = 5000;
const fuelBarColor_80to100 = 'rgb(0, 255, 0)';
const fuelBarColor_60to80 = 'rgb(0, 255, 255)';
const fuelBarColor_40to60 = 'rgb(0, 0, 255)';
const fuelBarColor_20to40 = 'rgb(255, 0, 255)';
const fuelBarColor_0to20 = 'rgb(255, 0, 0)';
