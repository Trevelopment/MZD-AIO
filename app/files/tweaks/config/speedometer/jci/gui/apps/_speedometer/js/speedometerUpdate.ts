...
function updateSpeedoApp() {
  ...
  function toggleFuelEffUnit() {
    ...
    const effUnit = (fuelEffunit_kml ? 'km/L ∅' : 'L/100 km ∅');
  ...
  function cycleAnalogThemes() {
    const analColors = ['Red', 'Green', 'Blue', 'Orange', 'Silver', 'Yellow', 'Purple', 'Pink'];
    const analIndex = analColors.indexOf(analogColor);
  ...
  function cycleLanguages() {
    const langs = ['EN', 'DE', 'ES', 'PL', 'SK', 'TR', 'FR', 'IT', 'NL'];
    const langIndex = langs.indexOf(language);
...
const SPDSBN_Speed_Unit = 'Speed Unit';
const SPDSBN_Temperature_Unit = 'Temperature Unit';
const SPDSBN_Fuel_Eff_Unit = 'Fuel Eff Unit';
const SPDSBN_Reset_Times_Speeds = 'Reset Times & Speeds';
const SPDSBN_Popped = 'Popped';
const SPDSBN_Digital_Bar_Speedometer = 'Digital Bar Speedometer';
const SPDSBN_Classic_Speedometer = 'Classic Speedometer';
const SPDSBN_Text_Large = 'Text Size: Large';
const SPDSBN_Text_Regular = 'Text Size: Small';
const SPDSBN_Speed_Analog = 'Speed: Analog';
const SPDSBN_Speed_Digital = 'Speed: Digital';
const SPDSBN_Speed_Bar = 'Speed Bar';
const SPDSBN_Hide_Speed_Bar = 'Hide Speed Bar';
const SPDSBN_Show_Speed_Bar = 'Show Speed Bar';
const SPDSBN_Speedometer_Color = 'Speedometer Color';
const SPDSBN_Theme = 'Theme';
const SPDSBN_Basic = 'Basic Speedometer';
const SPDSBN_Modded = 'Modded Speedometer';
const SPDSBN_Language = 'Language';
