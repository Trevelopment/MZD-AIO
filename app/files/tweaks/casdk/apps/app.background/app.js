  ...
  onControllerEvent: function(eventId) {
    switch (eventId) {
      ...
      case this.LEFT:
         ...
         */
      case this.RIGHT:
        if (this.select < this.max) this.select++;
        this.updatepos();
        break;
        /*
         ...
         */
      case this.UP:
        (this.select > 3) ? this.select -= 3: this.select = 0;
        this.updatepos();
        break;
        /*
         ...
         */
      case this.DOWN:
        (this.select < (this.max - 3)) ? this.select += 3: this.select = this.max;
        this.updatepos();
        break;
        /*
         ...
         */
      case this.CW:
        (this.select < this.max) ? this.select++: this.select = 0;
        this.updatepos();
        break;
        /*
         ...
         */
      case this.CCW:
        (this.select > 0) ? this.select--: this.select = this.max;
        this.updatepos();
        break;
        /*
