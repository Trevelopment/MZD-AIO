...
const CUSTOM_APPLICATION_VERSION = '0.1.0';
...
export class CustomApplication {
  ...
  // Old constructor
  // const CustomApplication = (application) => {
  ...
  __load = function(next) {
    let loaded = 0;
    let toload = 0;
    const isFinished = function(o: boolean | undefined) {
...
const CustomApplicationResourceLoader = {
  ...
  loadJavascript: function(scripts: any, path: any, callback: any, options?: any, async?: any) {
  ...
  loadCSS: function(css: any, path: any, callback: any, options?: any, async?: any) {
  ...
  __loadInvoker: function(items: any, path: any, build: any, callback?: any, opts?: any, async?: any) {
    const ids = false;
...
export const CustomApplicationsHandler = {
