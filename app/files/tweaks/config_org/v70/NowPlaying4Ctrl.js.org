...
function NowPlaying4Ctrl(uiaId, parentDiv, controlId, properties)
{
    ...
    this._styles = {
        "Style0":{"_ctrlTitle"            : "NowPlaying4CtrlHidden",
                  ...
                  "_titleImageFrame"    : "NowPlaying4CtrlHidden",
                  "_titleImage"         : "NowPlaying4CtrlHidden",
                 },
        ...
        "Style3":{"_ctrlTitle"            : "NowPlaying4CtrlTitleFull",
                  ...
                  "_rmStarNum4"           : "NowPlaying4CtrlHidden",
                  "_rmStarNum5"           : "NowPlaying4CtrlHidden",
                  "_titleImageFrame"      : "NowPlaying4CtrlTitleImageDiv",
                  "_titleImage"           : "NowPlaying4CtrlTitleImage",
                 },
...
"Style14":{"_ctrlTitle"           : "NowPlaying4CtrlTitle",
                  "_trackDisplay"         : "NowPlaying4CtrlHidden",
                  "_ctrlTitleIconFrame"   : "NowPlaying4CtrlHidden",
                  "_ctrlTitleIconImage"   : "NowPlaying4CtrlTitleIconImage",
                  "_hdDisplayFrame"       : "NowPlaying4CtrlHidden",
...
NowPlaying4Ctrl.prototype._createStructure = function()
{
    ...
    // create div for title image
    this._titleImageFrame = document.createElement('div');
    this._titleImageFrame.className = "NowPlaying4CtrlTitleImageDiv";
    this.divElt.appendChild(this._titleImageFrame);
    
    // create img for title image
    this._titleImage = document.createElement('img');
    this._titleImage.className = "NowPlaying4CtrlTitleImage";
    this._titleImageFrame.appendChild(this._titleImage);
...
NowPlaying4Ctrl.prototype.setNowPlayingConfig = function(config)
{
    ...
    if(this.properties.ctrlStyle)
    {
        this._clearTitleImage(config.titleImagePath);
    } 
...
NowPlaying4Ctrl.prototype.setHdConfig = function(hdConfigObj)
{
    ...
    if (hdConfigObj)
    {
        ...
        if ((this.properties.ctrlStyle === "Style2") ||
            ...
            (this.properties.ctrlStyle === "Style14"))
        {
...
/*
 * Sets the path to the  title image image
 * @param   imagePath    String for image path/file name
 */
NowPlaying4Ctrl.prototype.setTitleImagePath = function(imagePath)
{
    log.info("setTitleImagePath() called: " + imagePath);
    // Album Image
    if ((this.properties.ctrlStyle === "Style14") || (this.properties.ctrlStyle === "Style3"))
    {
        if (imagePath)
        {
            this._titleImageFrame.className = "NowPlaying4CtrlTitleImageDiv";
            this.properties.titleImagePath = imagePath;
            this._titleImage.src = this.properties.titleImagePath;
        }
        else
        {
            // Show placeholder icon instead of album image art
            this.properties.titleImagePath = "";
            this._titleImage.src = "";
            this._titleImageFrame.className = "NowPlaying4CtrlHidden";
        }
    }
};

NowPlaying4Ctrl.prototype._clearTitleImage = function(imagePath)
{
    log.debug("_clearTitleImage() called...");
    if (this.properties.ctrlStyle !== "Style14")
    {      
        // Hide the control title icon
        this._titleImage.src = "";
        this._titleImageFrame.className = "NowPlaying4CtrlHidden";
    }
    else if(!imagePath && this.properties.ctrlStyle === "Style14")
    {
        this._titleImage.src = "";
        this._titleImageFrame.className = "NowPlaying4CtrlHidden";
    }
...
// If the control is in a style supporting branding (e.g. "Style2", "Style4" "Style5", "Style7","style14"),
...
NowPlaying4Ctrl.prototype.setBrandImage = function(imagePath)
{
    ...
    if (imagePath)
    {
        ...
        if (((this.properties.ctrlStyle === "Style2") ||
             (this.properties.ctrlStyle === "Style3") ||
             (this.properties.ctrlStyle === "Style4") ||
             ...
             this.properties.ctrlTitleObj)
        {
            ...
            // If no HD configuration is in place (Style2 , Style4 ,style14), ...
