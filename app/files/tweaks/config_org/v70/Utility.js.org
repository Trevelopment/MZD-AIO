...
{
    log.debug("utility.hideSurface() FUNCTION DEPRECATED. GUI apps should set properties.visibleSurfaces in the context table instead.");
};
...
{
    log.debug("utility.showSurface() FUNCTION DEPRECATED. GUI apps should set properties.visibleSurfaces in the context table instead.");
};
...
{
    log.debug("utility.hideAllSurfaces() FUNCTION DEPRECATED. GUI apps should set properties.visibleSurfaces in the context table instead.");
};
...
{
    log.debug("utility.moveSurface() FUNCTION DEPRECATED.");
};
...
Utility.prototype.formatTime = function(timeSeconds, showSeconds) {
    ...
    if ((this.toType(timeSeconds) === "number") &&
        ...
        log.debug("utility.formatTime() called with unknown timeSeconds argument");
        timeStr = "Unknown";
    }
...
Utility.prototype.findTimeDuration = function(date1, date2)
{
    ...
    if (date1 >= date2)
    {
        log.debug("First date value is passed either greater or equal to second date value, Cannot find difference ");
        return 0;
    }
    else
    {
...
Utility.prototype.formatDate = function(timeSeconds) {
    ...
    {
        log.debug("utility.formatDate() called with unknown timeSeconds argument");
        dateStr = "Unknown";
    }
...
Utility.prototype.formatDateTime = function(timeSeconds, showSeconds) {
    ...
    if ((this.toType(timeSeconds) === "number") &&
        ...
        log.debug("utility.formatDateTime() called with unknown timeSeconds argument");
        dateTimeStr = "Unknown";
    }
...
Utility.prototype.formatSmartDateTime = function(timeSeconds, showSeconds) {
    ...
    if ((this.toType(timeSeconds) === "number") &&
        ...
        log.debug("utility.formatSmartDateTime() called with unknown timeSeconds argument");
        dateTimeStr = "Unknown";
    }
