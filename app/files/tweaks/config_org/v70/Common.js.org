...
function Common()
{
    ...
    this._displaySbUmpActivityTypes = "both"; // (String) "both" for both touch & MC input to count as activity, "touch" for touch-only input, "mousewheel" for mousewheel input
...
Common.prototype.commonControlsUpdateComplete = function(transitionData)
{
    ...
    if (this._cachedTemplate.properties.displaySbUmpActivityTypes === "both" ||
             ...
             this._cachedTemplate.properties.displaySbUmpActivityTypes === "mousewheel") {
...
Common.prototype._PageUpDownMsgHandler = function(msg)
{
    ...
    if (this._cachedTemplate && this._cachedTemplate.templateName === "xmdataList2Tmplt" && this._cachedTemplate.xmdataList2Ctrl && apiName)
    {
        // ... call that API!
        response = this._cachedTemplate.xmdataList2Ctrl[apiName]();
        result = response.charAt(0).toUpperCase() + response.slice(1);  // make sure first letter is uppercase
    }
...
Common.prototype._SelectLineNumMsgHandler = function(msg)
{
    ...
    if (this._cachedTemplate && this._cachedTemplate.templateName == "xmdataList2Tmplt")
    {
        // Does the list have data and support VUI?
        if (this._cachedTemplate.xmdataList2Ctrl.dataList && this._cachedTemplate.xmdataList2Ctrl.dataList.vuiSupport == true)
        {
            log.info("Sending Line Number to List: " + number);
            // List will return a result
            var response = this._cachedTemplate.xmdataList2Ctrl.selectLine(number);
...
Common.prototype.activityDetected = function(isActive, evt, tuiEvent)
{
    ...
    if (this._displaySbUmpByActivity)
    {
        ...
        {
            // Multicontroller(volume) event can trigger on "both" or "mousewheel"
            if (this._displaySbUmpActivityTypes == "both" || this._displaySbUmpActivityTypes == "mousewheel")
            {
                legalEvent = true;
            }
        }
...
Common.prototype._showHideLineNumbers = function(showLineNumbers)
{
    if (showLineNumbers == true && this._lineNumberData != null)
    {
        ...
        if (this._cachedTemplate && this._cachedTemplate.templateName == "xmdataList2Tmplt")
        {
            if ((this._cachedTemplate.xmdataList2Ctrl.dataList) &&
                (this._cachedTemplate.xmdataList2Ctrl.dataList.vuiSupport == true) &&
                (this._cachedTemplate.xmdataList2Ctrl.properties.numberedList == true) &&
                (this._cachedTemplate.xmdataList2Ctrl.dataList.hasOwnProperty('itemCount') && this._cachedTemplate.xmdataList2Ctrl.dataList.itemCount > 0))
            {
                this.leftBtn.showLineNumbers(this._lineNumberData.count, this._lineNumberData.style);
            }
...
Common.prototype._statusBarClicked = function(ctrlObj, appData, params)
{
    ...
    else if (params && (params.statusBtn == "carplay" || params.statusBtn == "androidauto"))
    {
...
Common.prototype._statusBarFocused = function(ctrlObj, appData, params)
{
    ...
    if (params && (params.statusBtn == "carplay" || params.statusBtn == "androidauto"))
    {
...
Common.prototype._statusBarLongPress = function(ctrlObj, appData, params)
{
    ...
    else if (params.statusBtn == "home")
    {
        framework.sendEventToMmui("common", "Global.IntentHomeLongPress");
    }
...
Common.prototype.beep = function(pressType, eventCause)
{
    ...
    framework.sendEventToMmui("system", "PlayAudioBeep", args);
};
