...
SbOpsHTML += '<span class="w3-row w3-col"><span class="speedo-radio third"> <input id="DigitalClockFont" type="checkbox" name="digiclock" ng-disabled="user.speedoOps.sml.id === 22" ng-model="user.speedoOps.digiclock" ng-value="user.speedoOps.digiclock"/><label for="DigitalClockFont" data-toggle="tooltip" data-placement="auto bottom" title="Change the clock font to a digital clock."> Digital Clock Mod </label></span>'
SbOpsHTML += '<span class="speedo-radio third"> <input id="ShowSBReverse" type="checkbox" name="sbreverse" ng-disabled="user.speedoOps.sml.id === 22" ng-model="user.speedoOps.sbreverse" ng-value="user.speedoOps.sbreverse"/><label for="ShowSBReverse" data-toggle="tooltip" data-placement="auto bottom" title="Hide Statusbar Speedometer in Reverse."> Hide In Reverse </label></span>'
SbOpsHTML += '<span class="speedo-radio third"> <input id="ShowSbInApp" type="checkbox" name="sbreverse" ng-disabled="user.speedoOps.sml.id === 22" ng-model="user.speedoOps.sbhideinapp" ng-value="user.speedoOps.sbhideinapp"/><label for="ShowSbInApp" data-toggle="tooltip" data-placement="auto bottom" title="Hide Statusbar Speedometer When Speedometer App Is Open."> Hide In App </label></span></span></span></div>'
